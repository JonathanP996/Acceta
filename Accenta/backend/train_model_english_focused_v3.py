...
BATCH_SIZE = 32
RANDOM_STATE = 42
TOP_N_CLASSES = 12  # Reduced to 12 classes (Arabic, Spanish, French removed) for better English detection
ENGLISH_BOOST_FACTOR = 2.0  # Boost English weight by 2x

# Select 12 languages that are phonetically DISTINCT from English
# This makes it easier for the model to identify English
# Arabic, Spanish, French removed - were causing false positives for English speakers
SELECTED_LANGUAGES = [
